...
export const metadata: Metadata = {
  ...
  description:
    "Halloween cakes Leeds from £35 | Spooky pumpkin & ghost designs | Custom themes | 5★ rated | Same-day delivery | Perfect for parties!",
  keywords:
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-orange-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center mb-16">
          ...
          >
            Spooktacular Halloween cakes for your frightfully fun celebrations. From cute to creepy,
        ...
        <section className="text-center">
          <Box sx={{ bgcolor: "purple.600", borderRadius: 2, p: 4, color: "white" }}>
            ...
            <Typography variant="h4" component="h3" className="text-xl mb-6">
              Order your spooktacular Halloween cakes today and make your celebration frightfully
              fun and delicious.
            </Typography>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
