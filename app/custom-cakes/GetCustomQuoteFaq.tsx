...
export const getCustomQuoteFaqItems: QuoteFaqItem[] = [
  {
    ...
    answer: 'Share your event date, approximate servings and your cake ideas. Put ordinary flavour and dietary preferences in your cake brief. Use the separate dietary health information field only for allergies, intolerances or health-related information.'
  },
  {
