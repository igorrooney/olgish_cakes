...
export function GetCustomQuoteHero() {
  return (
    <section className='overflow-hidden bg-base-100 px-4 pb-10 pt-6 tablet:px-10 tablet:pb-14 tablet:pt-8'>
      <nav aria-label='Breadcrumb' className='breadcrumbs homepage-container mb-5 text-sm text-base-content/75'>
        <ul>
          <li>
            <Link href='/'>Home</Link>
          </li>
      ...
      <div className='homepage-container relative grid items-center gap-10 small-laptop:grid-cols-[minmax(0,1.12fr)_minmax(360px,0.88fr)]'>
        <div className='relative z-[1] flex flex-col items-center gap-6 small-laptop:items-start'>
          ...
          <ul aria-label='Quote highlights' className='!m-0 flex w-full !list-none flex-col items-center gap-2 !p-0 font-body text-sm font-semibold leading-6 text-primary-800 tablet:flex-row tablet:flex-wrap tablet:justify-center tablet:gap-x-5 small-laptop:items-start small-laptop:justify-start'>
