...
export function GetCustomQuoteFormSection({
  ...
  return (
    <section
      ...
      tabIndex={-1}
      className='content-auto-section relative z-10 scroll-mt-24 bg-base-100 px-4 py-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 tablet:px-10 tablet:py-14'
    >
      <div className='homepage-container'>
        <div className='grid gap-8 small-laptop:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)]'>
          <div className='max-w-[420px]'>
            ...
            <h2 id='quote-form-heading' className='mt-3 font-moreSugar text-[28px] uppercase leading-[1.2] tracking-[0.1em] text-primary-700 tablet:text-[40px]'>
