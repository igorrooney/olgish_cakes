...
import { SensitiveDataConsentFields } from '../components/legal/SensitiveDataConsentFields'
...
export function GetCustomQuoteForm({
  ...
  const updateField = (
    field: Exclude<keyof GetCustomQuoteFormValues, 'dietaryHealthConsent'>,
    value: string,
  ...
  return (
    ...
    >
      ...
      <ValidatorInput
        ...
        labelAlt='(Required)'
        labelLayout='stacked'
        placeholder='Tell us the main idea, style, colours, flavour direction, dietary preferences, delivery or collection preference, and anything else that matters.'
      ...
      <div className='bottom-3'>
        ...
        {hasSubmittedSuccessfully ? null : (
          <p className='mt-3 text-center text-sm leading-6 text-base-content/70'>
            We&apos;ll reply as soon as we can. Please add either an email address or a phone number so we can get back to you.
          </p>
        )}
      </div>
    </form>
