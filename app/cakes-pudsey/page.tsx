...
export const metadata: Metadata = {
  ...
  description:
    "★★★★★ Cakes Pudsey from £25 | Traditional Ukrainian honey cake | Wedding & birthday | Same-day delivery | 127+ reviews | Order fresh Pudsey cakes today!",
  keywords:
...
export default async function CakesPudseyPage() {
  ...
  const structuredData = {
    ...
    description:
      "Real Ukrainian cakes available in Pudsey, Leeds. Traditional recipes and custom designs.",
    url: "https://olgishcakes.co.uk/cakes-pudsey",
  };
      ...
      >
        <Container maxWidth="lg">
          ...
          <Box sx={{ textAlign: "center", mb: { xs: 4, md: 6 } }}>
            ...
            >
              Real Ukrainian honey cake, Kyiv cake, and traditional desserts delivered to your
              door in Pudsey
            </Typography>
              ...
              {[
                ...
                <Grid item xs={12} sm={6} md={4} key={index}>
                  ...
                  >
                    ...
                    <Typography variant="h4" component="h3" sx={{ mb: 1, color: "#005BBB" }}>
                      {feature.title}
                    </Typography>
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 3, fontSize: "1.1rem" }}>
              Experience the real taste of Ukraine with my traditional cakes delivered to
              Pudsey
            </Typography>
            <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
              <Button
