...
export const metadata: Metadata = {
  ...
  description:
    "Cake delivery Leeds from £5 | Same-day delivery | Fresh Ukrainian cakes | 5★ rated | Serving Leeds & Yorkshire | Order before 10am today!",
  keywords:
    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          {/* Breadcrumbs */}
          <Box sx={{ mb: 3 }}>
            <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Delivery Areas" }]} />
          </Box>
