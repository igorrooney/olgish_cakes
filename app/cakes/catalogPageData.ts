...
const fallbackCakes: TabletCake[] = [
  ...
  },
  {
    ...
    navigationTarget: 'landing',
    name: 'Anniversary cakes in Leeds',
    description: 'Explore handmade anniversary cake ideas for intimate gatherings and milestone celebrations before requesting a quote.',
    price: 58,
    imageUrl: '/images/placeholder-cake.jpg',
    imageAlt: 'Anniversary cake inspiration from Olgish Cakes',
    isByPost: false,
    isCustom: true,
    isPopular: false,
    collectionIds: [],
  ...
  },
  {
    ...
    href: '/wedding-cakes',
    navigationTarget: 'landing',
    name: 'Wedding cakes in Leeds',
    description: 'See elegant wedding cake styles, flavours, and planning ideas before sending through your brief.',
    price: 42,
    imageUrl: '/images/placeholder-cake.jpg',
    imageAlt: 'Wedding cake inspiration from Olgish Cakes',
    isByPost: false,
    isCustom: true,
    isPopular: true,
    collectionIds: [],
