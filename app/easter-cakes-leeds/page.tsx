...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Order traditional Ukrainian Easter cakes in Leeds. Paska, babka, and Easter-themed cakes with real recipes.",
    type: "website",
...
const structuredData = {
  ...
  description:
    "Traditional Ukrainian Easter cakes in Leeds including Paska and Babka. Real recipes and Easter-themed designs.",
  provider: {
    "@type": "LocalBusiness",
    name: "Olgish Cakes",
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-yellow-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center mb-16">
          ...
          >
            Celebrate Easter with my traditional Ukrainian Easter cakes. From real Paska to beautiful
        ...
        <section className="text-center">
          <Box sx={{ bgcolor: "green.600", borderRadius: 2, p: 4, color: "white" }}>
            <Typography variant="h3" className="text-3xl font-bold mb-4">
              Celebrate Easter with traditional Traditions
            </Typography>
            <Typography variant="h4" component="h3" className="text-xl mb-6">
              Order your traditional Ukrainian Easter cakes today and make your celebration real and
              special.
            </Typography>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
