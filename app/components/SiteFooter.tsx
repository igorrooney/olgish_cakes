  ...
  return (
    <>
      ...
      <footer className="bg-base-100 text-base-content">
        ...
        <div className="footer grid-flow-row place-items-start text-left tablet:!grid-flow-col tablet:items-center tablet:flex-start border-base-300 border-t px-6 py-6 lg:px-20 tablet:py-6">
