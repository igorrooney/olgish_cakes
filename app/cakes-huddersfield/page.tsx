        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mb: 3, textAlign: "center", lineHeight: 1.8 }}>
              Looking for specific cake types in Huddersfield? View our <Link href="/wedding-cakes" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>wedding cakes</Link>, <Link href="/birthday-cakes" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>birthday cakes</Link>, <Link href="/celebration-cakes" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>celebration cakes</Link>, or <Link href="/vegan-cakes-leeds" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>vegan cakes</Link>.
            </Typography>
