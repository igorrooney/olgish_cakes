        ...
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ mb: 3, textAlign: "center", lineHeight: 1.8 }}>
              Browse our full range of cakes: <Link href="/wedding-cakes" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>wedding cakes</Link>, <Link href="/birthday-cakes" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>birthday cakes</Link>, <Link href="/anniversary-cakes-leeds" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>anniversary cakes</Link>, <Link href="/vegan-cakes-leeds" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>vegan cakes</Link>, and <Link href="/custom-cake-design" style={{ color: "inherit", textDecoration: "underline", fontWeight: 600 }}>custom cake design</Link>.
            </Typography>
