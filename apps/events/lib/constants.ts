...
export const PUBLIC_UPLOAD_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000
export const PUBLIC_UPLOAD_RATE_LIMIT_MAX = 30
export const PUBLIC_REQUEST_IP_RATE_LIMIT_WINDOW_MS = 15 * 60 * 1000
export const PUBLIC_REQUEST_IP_RATE_LIMIT_MAX = 15
export const PUBLIC_REQUEST_EMAIL_RATE_LIMIT_WINDOW_MS = 60 * 60 * 1000
export const PUBLIC_REQUEST_EMAIL_RATE_LIMIT_MAX = 3
