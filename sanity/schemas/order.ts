    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: 'boolean',
          description: 'Whether the order confirmation email was successfully sent to the customer',
        }),
        defineField({
          name: 'emailError',
          title: 'Email Error',
        ...
        defineField({
          ...
          title: 'Email Attempted At',
          type: 'datetime',
          description: 'Timestamp when email was attempted',
        }),
      ],
    }),
  ],
