...
const COLLECTION_OPTIONS_QUERY = `*[_type == "giftHamperCollection"] | order(_updatedAt desc) {
  _id,
  name,
  isFeatured,
  homepageOrder
...
export function GiftHamperCollectionsInput(props: ArrayOfObjectsInputProps<CollectionReferenceValue>) {
  ...
  useEffect(() => {
    ...
    async function loadCollections() {
      ...
      try {
        ...
        console.error('Failed to load collections for gift hamper selector:', error)
