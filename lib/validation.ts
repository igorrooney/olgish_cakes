...
export const orderSchema = z.object({
  ...
  productType: z.enum(['cake', 'gift-hamper', 'hamper', 'custom', 'catalog']).default('custom'),
  ...
  deliveryMethod: z.enum(['collection', 'local-delivery', 'courier', 'postal', 'postal-delivery', 'market-pickup']).default('collection'),
  deliveryAddress: z.string().max(500).optional(),
  deliveryNotes: z.string().max(500).optional(),
  giftNote: z.string().max(500).optional(),
  note: z.string().max(1000).optional(),
  paymentMethod: z.enum(['cash-collection', 'card-collection', 'online', 'card', 'bank-transfer', 'paypal']).default('cash-collection'),
